Public Module VBCodeExecutor
    ...
    ''' <summary>
    ''' Returns the BPM stubs source code as a string
    ''' This provides stub implementations for BPM-specific types and functions
    ''' </summary>
    Private Function GetBPMStubsCode() As String
        Return "
''' <summary>
...
"
    ...
    Private Function ExecuteVBCodeInternal(vbCodeString As String, parameters As Object(), customLogger As System.Action(Of String)) As String
        Try
            ...
            ' Add stubs as a separate syntax tree
